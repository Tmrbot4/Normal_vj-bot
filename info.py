...
BOT_TOKEN = environ.get('BOT_TOKEN', "6737943130:AAHnaWVIdEB94Z5mZ5KxzxEjEAQYZGdFL1I")

# Bot settings
CACHE_TIME = int(environ.get('CACHE_TIME', 1800))
PICS = (environ.get('PICS', 'https://graph.org/file/31e01d9d1ca5b52a0548f.jpg')).split() #SAMPLE PIC
NOR_IMG = environ.get("NOR_IMG", "https://graph.org/file/31e01d9d1ca5b52a0548f.jpg")
MELCOW_VID = environ.get("MELCOW_VID", "https://graph.org/file/31e01d9d1ca5b52a0548f.jpg")
...
auth_channel = environ.get('AUTH_CHANNEL', '-1001937292511') # give your force subscribe channel id here else leave it blank
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://tmr624062:cUwBBBnK8n27k9FR@cluster0.v8m5hou.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_NAME = environ.get('DATABASE_NAME', "Ajanta")
...
CLONE_DATABASE_URI = environ.get('CLONE_DATABASE_URI', "mongodb+srv://sushankm16:4i1WAfPYKWyqPIDD@cluster0.sngp9pz.mongodb.net/?retryWrites=true&w=majority") # Necessary If clone mode is true
PUBLIC_FILE_CHANNEL = environ.get('PUBLIC_FILE_CHANNEL', 'fhjjhjjkkfgjk') # Public Channel Username Without @ and Bot Is Admin With Full Right.
